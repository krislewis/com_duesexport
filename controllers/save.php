...
function duesexport_saveusers($delimiter){
	...
	$query_3_join="SELECT c.firstname, c.middlename, c.lastname, c.user_id, u.email, c.cb_memberstatus, c.cb_memberlevel, d.year, d.status, d.date_paid, d.modified_by ";
	...
	// write header array
	$titlearray=array("First Name", "Middle","Last Name", "ID", "Email", "Status", "Level", "Year", "Paid Status", "Date Paid", "Modified");
